return {
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, "CursorLineNr", { fg = "#FD971F", bg = "#3b3a32" })
      ...
      vim.api.nvim_set_hl(0, "DiagnosticError", { fg = vim.g.terminal_color_1 })
      vim.api.nvim_set_hl(0, "DiagnosticWarn", { fg = "#FD971F" })
      vim.api.nvim_set_hl(0, "DiagnosticInfo", { fg = vim.g.terminal_color_4 })
